...
def find_features(img1):
    correct_matches_dct = {}
    directory = "/Users/andreisokolov/Documents/GitHub/GitHub/python/opencv/sample/"
...
if __name__ == '__main__':
    main_image = cv2.imread("/Users/andreisokolov/Documents/GitHub/GitHub/python/opencv/main_image/cards.jpg")
...
image = cv2.imread("/Users/andreisokolov/Documents/GitHub/GitHub/python/opencv/main_image/cards.jpg")
...
edges0 = cv2.Canny(gray_image, 50, 100)
edges1 = cv2.Canny(gray_image, 100, 200)
edges2 = cv2.Canny(gray_image, 200, 200)

# Display the images
cv2.imshow('Original', image)
cv2.imshow('Edges50100', edges0)
cv2.imshow('Edges100200', edges1)
cv2.imshow('Edges200200', edges2)
cv2.waitKey(0)
