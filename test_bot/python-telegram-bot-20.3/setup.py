...
def get_requirements():
    ...
    with Path("/Users/andreisokolov/Documents/GitHub/GitHub/test_bot/python-telegram-bot-20.3/requirements.txt").open() as reqs:
        for install in reqs:
...
def get_optional_requirements(raw=False):
    ...
    with Path("/Users/andreisokolov/Documents/GitHub/GitHub/test_bot/python-telegram-bot-20.3/requirements-opts.txt").open() as reqs:
        for line in reqs:
            line = line.strip()
...
def get_setup_kwargs(raw=False):
    ...
    version_file = Path("/Users/andreisokolov/Documents/GitHub/GitHub/test_bot/python-telegram-bot-20.3/telegram/_version.py").read_text()
    ...
    kwargs = dict(
        ...
        long_description=Path("/Users/andreisokolov/Documents/GitHub/GitHub/test_bot/python-telegram-bot-20.3/readme.rst").read_text(),
